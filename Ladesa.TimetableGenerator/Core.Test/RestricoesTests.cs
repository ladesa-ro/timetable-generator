...
public static class RestricoesTest
{
    ...
    //     public static void HorarioAlmoçoTurmaTest(
    //         IEnumerable<HorarioGeradoAula> horarioGerado,
    //         GerarHorarioContext contexto
    //     )
    //     {
    ...
    //         {
    //             var propostaAulaTurma =
    //                 from proposta in horarioGerado
    //                 where
    //                     (proposta.DiaDaSemanaIso == 2 || proposta.DiaDaSemanaIso == 4)
    //                     && proposta.TurmaId == turma.Id
    //                     && (
    //                         IntervaloDeTempo.VerificarIntervalo(
    //                             new IntervaloDeTempo("11:30:00", "11:59:59"),
    ...
    //     }
    //
    //     public static void MinimoDozeHorasEntreTurnosProfesssorTest(
    //         IEnumerable<HorarioGeradoAula> horarioGerado,
    //         GerarHorarioContext contexto
    //     )
    //     {
    ...
    //                 from proposta in horarioGerado
    //                 where
    //                     proposta.DiaDaSemanaIso == professor.DiaPRD
    //                     && proposta.ProfessorId == professor.Id
    //                 select proposta;
    //
    ...
    //     public static void EscolherTurnoProfessorTest(
    //         IEnumerable<HorarioGeradoAula> horarioGerado,
    //         GerarHorarioContext contexto
    //     )
    //     {
