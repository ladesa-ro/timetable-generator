...
public interface IRegraDisponibilidade
{
    public bool VerificarDisponibilidade(
        ...
        IntervaloDeTempo intervaloVerificacao
    );
}
...
public record RegraIndisponibilidadeDataEspecifica(DateOnly Data, IntervaloDeTempo Intervalo)
    : IRegraDisponibilidade
{
    public bool VerificarDisponibilidade(
        DateOnly dataVerificacao,
...
public record RegraIndisponibilidadeDiaDoMes(int DiaDoMes, IntervaloDeTempo Intervalo)
    : IRegraDisponibilidade
{
    public bool VerificarDisponibilidade(
        DateOnly dataVerificacao,
...
public record RegraIndisponibilidadeMesesDoAno(int[] Meses, IntervaloDeTempo Intervalo)
    : IRegraDisponibilidade
{
    public bool VerificarDisponibilidade(
        DateOnly dataVerificacao,
