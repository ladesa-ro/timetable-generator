...
public sealed partial class AvailabilityRuleUnavailableMonthDay : IMessage<AvailabilityRuleUnavailableMonthDay>
#if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
    , IBufferMessage
#endif
{
    private static readonly MessageParser<AvailabilityRuleUnavailableMonthDay> _parser = new(() =>
        new AvailabilityRuleUnavailableMonthDay());

    private UnknownFieldSet _unknownFields;

    [System.Diagnostics.DebuggerNonUserCodeAttribute]
    [System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static MessageParser<AvailabilityRuleUnavailableMonthDay> Parser => _parser;

    [System.Diagnostics.DebuggerNonUserCodeAttribute]
    [System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pbr::MessageDescriptor Descriptor => AvailabilityRuleReflection.Descriptor.MessageTypes[7];
    ...
    public int CalculateSize()
    {
        ...
        if (MonthDay != 0) size += 1 + pb::CodedOutputStream.ComputeInt32Size(MonthDay);
    ...
    public void MergeFrom(AvailabilityRuleUnavailableMonthDay other)
    {
        ...
        if (other.MonthDay != 0) MonthDay = other.MonthDay;
        if (other.slot_ != null)
        {
