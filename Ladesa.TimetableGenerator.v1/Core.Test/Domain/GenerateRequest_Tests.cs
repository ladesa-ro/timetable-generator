...
public class GenerateRequest_Tests
{
    ...
    public void Duplicate_Group_IDs_ShouldThrow()
    {
        ...
        Assert.Throws<Ladesa.TimetableGenerator.v1.Core.Generator.GeneratorValidationException>(() => Builders.Request(
            start: date,
            end: date,
            groups: [g1, g2],
            teachers: [Builders.Teacher()],
    ...
    public void GenerateTimetables_DiaryReferencesMissingGroup_ShouldThrow()
    {
        ...
        var ex = Assert.Throws<Ladesa.TimetableGenerator.v1.Core.Generator.GeneratorValidationException>(() => Generator.GenerateTimetables(req).First());
