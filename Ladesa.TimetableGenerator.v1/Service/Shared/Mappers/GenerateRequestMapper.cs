...
{
    public static Core.Domain.GenerateRequest ToCoreDomainEntity(Msg.GenerateRequest dto)
    {
    ...
    public static Core.Domain.GenerateRequest ToCoreDomainEntity(Msg.GenerateRequestClass dto)
    {
        var coreDomainEntity = new Core.Domain.GenerateRequest(
            DateOnly.FromDateTime(dto.DateStart.DateTime),
            DateOnly.FromDateTime(dto.DateEnd.DateTime),
    ...
    public static Msg.GenerateRequestClass ToMessagesDto(Core.Domain.GenerateRequest coreDomainEntity)
    {
